--[[
    Z7F Script - ULTIMATE EDITION
    Full Features Version with Anti-Copy, Anti-Kill, and All Systems
...
local function createRightsPage()
    ...
    VersionInfo.Text = "الإصدار: 5.0.0 ULTIMATE"
...
AntiCopyButton.MouseButton1Click:Connect(function()
    ...
    if antiCopyActive then
        ...
        antiCopyMeta.__newindex = function(t, k, v)
            if tostring(k):lower():find("script") or tostring(v):lower():find("z7f") then
                createNotification("Z7F", "تم منع محاولة نسخ!", "rbxassetid://7992557358", 3)
                return
            end
            rawset(t, k, v)
        end
        ...
        createNotification("Z7F", "تم تشغيل مضاد النسخ", "rbxassetid://7992557358", 3)
    else
        AntiCopyButton.Text = "مضاد النسخ: ❌"
...
warn("Z7F Script by Z7F ON TOP - Ultimate Edition")
